class TableMixin {
    ...
    renderTable() {
        ...
        table.classList.add('table', 'table-striped', 'table-hover', 'table-bordered'); // Add Bootstrap table classes
    ...
    renderPaginationControls() {
        ...
        this.paginationContainer.classList.add('d-flex', 'justify-content-center', 'mt-3'); // Center pagination
